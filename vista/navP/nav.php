...
<head>
    <!-- <?php session_start();?> -->
	<meta charset="UTF-8">
	<link rel="stylesheet" href="../navP/css/nav.css">
    ...
    <div class='navegation'>
        ...
        <?php       }else{ ?>
                <!-- Invitado -->
                <a href="index.php" class="logoI" ><img src='Imagenes/Logo.png' width='250px' height='50px'></a>
                <?php } ?>
        <a href="index.php">Inicio</a>
		<a href="index.php#aprende">Aprende a reciclar</a>
		...
		<a href="index.php#quien">¿Quienes somos?</a>
